...
Drivers/STM32L4xx_HAL_Driver/Src/%.o: ../Drivers/STM32L4xx_HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 '-D__weak=__attribute__((weak))' '-D__packed="__attribute__((__packed__))"' -DUSE_HAL_DRIVER -DSTM32L432xx -I"/hdd/STM32WS/PWM-NEW-BLDC-SERVO/Inc" -I"/hdd/STM32WS/PWM-NEW-BLDC-SERVO/Drivers/STM32L4xx_HAL_Driver/Inc" -I"/hdd/STM32WS/PWM-NEW-BLDC-SERVO/Drivers/STM32L4xx_HAL_Driver/Inc/Legacy" -I"/hdd/STM32WS/PWM-NEW-BLDC-SERVO/Drivers/CMSIS/Device/ST/STM32L4xx/Include" -I"/hdd/STM32WS/PWM-NEW-BLDC-SERVO/Drivers/CMSIS/Include"  -Og -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
